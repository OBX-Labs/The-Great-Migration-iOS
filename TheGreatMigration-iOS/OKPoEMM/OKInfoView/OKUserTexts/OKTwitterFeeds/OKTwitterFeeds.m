...
#warning Make sure you set this to something that looks like the current poemm
...
- (void) handleTwitterFeed:(NSString*)feed
{
    if(feed != nil)
    {
        ...
        if([[OKTextManager sharedInstance] saveCustomText:feed forTitle:cFeed])
        {
            ...
            NSLog(@"Need to add custom text loader here (e.g. [eagl setupFont]; for Know.)");
        }
        else
        {
