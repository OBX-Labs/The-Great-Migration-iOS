...
// Prompt email composer without properties
// This could probably be replaced by [self presentMFMailComposeViewControllerAnimatied:aAnimated withProperties:nil];
...
// Prompt social share without properties
// This could probably be replaced by [presentSLComposeViewControllerAnimatied:aAnimated forServiceType:serviceType withProperties:nil];
...
// Prompt social share with properties
